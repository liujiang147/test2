...
var ReqUrl={
    ...
    LoginReqUrl:function() {
        return (environment==0?"http://localhost:8089/api/":"http://user.local.com/api/");
    },
    ToAliPayReqUrl:function () {
        return (environment==0?"http://localhost:8088/api/":"http://aliPay.local.com/api/");
    },
    ToWxPayUrl:function () {
        return (environment==0?"http://localhost:8087/api/":"http://wxPay.local.com/api/");
    }
};
//设置cookie
